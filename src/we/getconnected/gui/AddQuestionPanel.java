...
public class AddQuestionPanel extends JPanel {
     ...
     */
    public AddQuestionPanel() {setLayout(null);
        ...
        btnTestUrl.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ImageIcon rawImg = new ImageIcon(Main.getImage(txtUrl.getText())); // Hier word de Img opgehaald en in een icon gezet
                ...
                if (rawImg.getIconHeight() > rawImg.getIconWidth()) {  // Kijkt of de image Portait is                 
                    if (rawImg.getIconHeight() >= MainPanel.MAP_AREA.height) {   // kijkt naar de hoogte van de image                       
                        ImageIcon importImg = new ImageIcon(
                                Main.getImage(txtUrl.getText()).getScaledInstance(-1,
                        ...
                        lblMapPreview.setIcon(importImg);
                    ...
                    if (rawImg.getIconWidth() >= MainPanel.MAP_AREA.width) {     //kijkt naar de breedte van de image
                        ImageIcon importImg = new ImageIcon(
                                Main.getImage(txtUrl.getText()).getScaledInstance(MainPanel.MAP_AREA.width,
                                -1, Image.SCALE_FAST));
                ...
                if (rawImg.getIconHeight() <= MainPanel.MAP_AREA.height && rawImg.getIconWidth() <= MainPanel.MAP_AREA.width) {
                    ...
                    ImageIcon importImg = new ImageIcon(Main.getImage(txtUrl.getText()));
                    lblMapPreview.setIcon(importImg);
                    lblMapPreview.setBounds((MainPanel.MAP_AREA.width - importImg.getIconWidth()) / 2,
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //vraag om bevestiging alvorens verder te gaan
                    ...
                    Question question = new Question(question_id
                        , txtQuestion.getText(), txtUrl.getText(), answers, country_id);
        ...
        mapArea.addMouseListener(new MouseListener(){
            ...
            public void mouseClicked(MouseEvent e) {
                /**
                 * log de mouse coordinates en trekt de helft van de DEFAULT_BUTTON
                 * eraf zodat bij een klik op de maparea de punt in het midden
                 * van de muisklik komt te staan
                 */
